 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lm;function G1(){return Lm||(Lm=1,(function(n){function i(G,W){var F=G.length;G.push(W);e:for(;0<F;){var ie=F-1>>>1,fe=G[ie];if(0<o(fe,W))G[ie]=W,G[F]=fe,F=ie;else break e}}function r(G){return G.length===0?null:G[0]}function s(G){if(G.length===0)return null;var W=G[0],F=G.pop();if(F!==W){G[0]=F;e:for(var ie=0,fe=G.length,C=fe>>>1;ie<C;){var V=2*(ie+1)-1,ee=G[V],ae=V+1,de=G[ae];if(0>o(ee,F))ae<fe&&0>o(de,ee)?(G[ie]=de,G[ae]=F,ie=ae):(G[ie]=ee,G[V]=F,ie=V);else if(ae<fe&&0>o(de,F))G[ie]=de,G[ae]=F,ie=ae;else break e}}return W}function o(G,W){var F=G.sortIndex-W.sortIndex;return F!==0?F:G.id-W.id}if(n.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;n.unstable_now=function(){return c.now()}}else{var d=Date,g=d.now();n.unstable_now=function(){return d.now()-g}}var p=[],h=[],x=1,v=null,E=3,S=!1,b=!1,A=!1,w=!1,_=typeof setTimeout=="function"?setTimeout:null,D=typeof clearTimeout=="function"?clearTimeout:null,j=typeof setImmediate<"u"?setImmediate:null;function Q(G){for(var W=r(h);W!==null;){if(W.callback===null)s(h);else if(W.startTime<=G)s(h),W.sortIndex=W.expirationTime,i(p,W);else break;W=r(h)}}function $(G){if(A=!1,Q(G),!b)if(r(p)!==null)b=!0,U||(U=!0,I());else{var W=r(h);W!==null&&ze($,W.startTime-G)}}var U=!1,B=-1,q=5,ne=-1;function P(){return w?!0:!(n.unstable_now()-ne<q)}function J(){if(w=!1,U){var G=n.unstable_now();ne=G;var W=!0;try{e:{b=!1,A&&(A=!1,D(B),B=-1),S=!0;var F=E;try{t:{for(Q(G),v=r(p);v!==null&&!(v.expirationTime>G&&P());){var ie=v.callback;if(typeof ie=="function"){v.callback=null,E=v.priorityLevel;var fe=ie(v.expirationTime<=G);if(G=n.unstable_now(),typeof fe=="function"){v.callback=fe,Q(G),W=!0;break t}v===r(p)&&s(p),Q(G)}else s(p);v=r(p)}if(v!==null)W=!0;else{var C=r(h);C!==null&&ze($,C.startTime-G),W=!1}}break e}finally{v=null,E=F,S=!1}W=void 0}}finally{W?I():U=!1}}}var I;if(typeof j=="function")I=function(){j(J)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,oe=se.port2;se.port1.onmessage=J,I=function(){oe.postMessage(null)}}else I=function(){_(J,0)};function ze(G,W){B=_(function(){G(n.unstable_now())},W)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(G){G.callback=null},n.unstable_forceFrameRate=function(G){0>G||125<G?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):q=0<G?Math.floor(1e3/G):5},n.unstable_getCurrentPriorityLevel=function(){return E},n.unstable_next=function(G){switch(E){case 1:case 2:case 3:var W=3;break;default:W=E}var F=E;E=W;try{return G()}finally{E=F}},n.unstable_requestPaint=function(){w=!0},n.unstable_runWithPriority=function(G,W){switch(G){case 1:case 2:case 3:case 4:case 5:break;default:G=3}var F=E;E=G;try{return W()}finally{E=F}},n.unstable_scheduleCallback=function(G,W,F){var ie=n.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?ie+F:ie):F=ie,G){case 1:var fe=-1;break;case 2:fe=250;break;case 5:fe=1073741823;break;case 4:fe=1e4;break;default:fe=5e3}return fe=F+fe,G={id:x++,callback:W,priorityLevel:G,startTime:F,expirationTime:fe,sortIndex:-1},F>ie?(G.sortIndex=F,i(h,G),r(p)===null&&G===r(h)&&(A?(D(B),B=-1):A=!0,ze($,F-ie))):(G.sortIndex=fe,i(p,G),b||S||(b=!0,U||(U=!0,I()))),G},n.unstable_shouldYield=P,n.unstable_wrapCallback=function(G){var W=E;return function(){var F=E;E=W;try{return G.apply(this,arguments)}finally{E=F}}}})(Tc)),Tc}var Bm;function k1(){return Bm||(Bm=1,Ec.exports=G1()),Ec.exports}var zc={exports:{}},ct={};/**
 * @license React
...
`;function Yc(){const{id:n}=Ty(),i=Ni(),r=window.location.pathname,[s,o]=M.useState(null),[c,d]=M.useState([]),[g,p]=M.useState([]),[h,x]=M.useState([]),[v,E]=M.useState(!0),[S,b]=M.useState(null),[A,w]=M.useState(!1),[_,D]=M.useState(!0);M.useEffect(()=>{async function q(){E(!0),b(null);try{const ne=r.includes("/serie/"),P=r.includes("/movie/");if(ne){const[J,I,se,oe]=await Promise.all([of(n),z0(n),C0(n),T0(n)]);if(oe&&oe.id)o(oe),d(J||[]),p(I||[]),x(se||[]),D(!1);else throw new Error("Série não encontrada")}else if(P){const[J,I,se,oe]=await Promise.all([sf(n),S0(n),w0(n),E0(n)]);if(oe&&oe.id)o(oe),d(J||[]),p(I||[]),x(se||[]),D(!0);else throw new Error("Filme não encontrado")}else{let J,I,se,oe,ze,G,W,F;try{if([I,se,oe,J]=await Promise.all([sf(n),S0(n),w0(n),E0(n)]),J&&J.id)o(J),d(I||[]),p(se||[]),x(oe||[]),D(!0);else throw new Error("Movie not found")}catch{try{if([G,W,F,ze]=await Promise.all([of(n),z0(n),C0(n),T0(n)]),ze&&ze.id)o(ze),d(G||[]),p(W||[]),x(F||[]),D(!1);else throw new Error("Content not found")}catch{throw new Error("Conteúdo não encontrado")}}}}catch(ne){b(ne.message)}finally{E(!1)}}n&&q()},[n,r]);const j=q=>{if(!q)return"";const ne=Math.floor(q/60),P=q%60;return`${ne}h ${P}min`},Q=q=>q?new Date(q).toLocaleDateString("pt-BR",{year:"numeric",month:"long",day:"numeric"}):"",$=q=>q?new Intl.NumberFormat("pt-BR",{style:"currency",currency:"USD"}).format(q):"";if(v)return z.jsxs(ST,{children:[z.jsx("div",{className:"spinner"}),z.jsx("p",{children:"Carregando detalhes..."})]});if(S||!s)return z.jsxs(wT,{children:[z.jsx("h2",{children:"😔 Ops!"}),z.jsx("p",{children:S||"Conteúdo não encontrado"}),z.jsx(ef,{onClick:()=>i(-1),children:"Voltar"})]});const U=_?s.title:s.name,B=_?s.release_date:s.first_air_date;return z.jsxs(z.Fragment,{children:[A&&z.jsx(to,{movieId:_?s.id:null,seriesId:_?null:s.id,setShowModal:w}),s.backdrop_path&&z.jsx(iT,{image:jn(s.backdrop_path)}),z.jsxs(lT,{children:[z.jsx(rT,{onClick:()=>i(-1),children:"← Voltar"}),z.jsx(sT,{children:s.poster_path&&z.jsx("img",{src:jn(s.poster_path),alt:U})}),z.jsxs(oT,{children:[z.jsx("h1",{children:U}),s.tagline&&z.jsxs(uT,{children:['"',s.tagline,'"']}),z.jsxs(cT,{children:[z.jsxs(fT,{children:["⭐ ",s.vote_average?.toFixed(1),"/10",z.jsxs("span",{children:["(",s.vote_count," votos)"]})]}),_&&s.runtime&&z.jsxs(U0,{children:["⏱️ ",j(s.runtime)]}),!_&&s.number_of_seasons&&z.jsxs(U0,{children:["📺 ",s.number_of_seasons," temporada",s.number_of_seasons>1?"s":""]}),z.jsxs(dT,{children:["📅 ",Q(B)]})]}),z.jsx(tT,{genres:s.genres}),z.jsx(pT,{children:s.overview}),z.jsxs(hT,{children:[z.jsx(mT,{onClick:()=>i("/"),children:"▶️ Assistir Agora"}),c.length>0&&z.jsx(gT,{onClick:()=>w(!0),children:"🎬 Ver Trailer"})]}),z.jsx(ES,{movieCredits:g})]})]}),z.jsxs(xT,{children:[z.jsxs(vT,{children:[z.jsx("h3",{children:"📊 Informações Detalhadas"}),z.jsxs("div",{children:[z.jsxs(Ma,{children:[z.jsx("strong",{children:"Status:"})," ",s.status]}),z.jsxs(Ma,{children:[z.jsx("strong",{children:"Idioma Original:"})," ",s.original_language?.toUpperCase()]}),_&&z.jsxs(z.Fragment,{children:[z.jsxs(Ma,{children:[z.jsx("strong",{children:"Orçamento:"})," ",s.budget?$(s.budget):"Não informado"]}),z.jsxs(Ma,{children:[z.jsx("strong",{children:"Receita:"})," ",s.revenue?$(s.revenue):"Não informado"]})]}),!_&&z.jsxs(z.Fragment,{children:[z.jsxs(Ma,{children:[z.jsx("strong",{children:"Episódios:"})," ",s.number_of_episodes||"Não informado"]}),z.jsxs(Ma,{children:[z.jsx("strong",{children:"Última exibição:"})," ",s.last_air_date?Q(s.last_air_date):"Não informado"]}),s.networks&&s.networks.length>0&&z.jsxs(Ma,{children:[z.jsx("strong",{children:"Redes:"})," ",s.networks.map(q=>q.name).join(", ")]})]})]})]}),s.production_companies&&s.production_companies.length>0&&z.jsxs(yT,{children:[z.jsx("h3",{children:"🏢 Produção"}),z.jsx("div",{children:s.production_companies.map(q=>z.jsxs("div",{children:[q.logo_path&&z.jsx(bT,{children:z.jsx("img",{src:jn(q.logo_path),alt:q.name,onError:ne=>{ne.target.style.display="none"}})}),z.jsx("span",{children:q.name})]},q.id))})]})]}),h&&h.length>0&&z.jsx(Ll,{info:h,title:_?"Filmes Similares":"Séries Similares",contentType:_?"movie":"series"})]})}const ET=$l`
  from {
    transform: scale(0);
  }
to {
...
`;function XT(){const[n,i]=M.useState([]),[r,s]=M.useState(!0),[o,c]=M.useState("popular"),[d,g]=M.useState(1),[p,h]=M.useState(1),[x,v]=M.useState(!1),[E]=M.useState(null),[S,b]=M.useState(!1),A=Ni(),w=[{key:"popular",label:"Populares",fetchFunction:aE},{key:"top_rated",label:"Melhores Avaliados",fetchFunction:rE},{key:"now_playing",label:"Em Cartaz",fetchFunction:iE},{key:"upcoming",label:"Em Breve",fetchFunction:lE}],_=async(U,B=1,q=!1)=>{s(!0);try{const P=await w.find(J=>J.key===U).fetchFunction(B);if(P){if(q){const J=n.map(se=>se.id),I=P.results.filter(se=>!J.includes(se.id));I.length>0&&i(se=>[...se,...I])}else i(P.results);h(P.total_pages),g(B)}}catch(ne){console.error("Error fetching movies:",ne)}finally{s(!1)}};M.useEffect(()=>{_(o,1)},[o]);const D=U=>{U!==o&&(c(U),g(1))},j=async()=>{if(d<p&&!r&&!S){b(!0);let U=d+1,B=0;const q=3;let ne=!1;for(;B<q&&U<=p&&!ne;)try{const J=await w.find(I=>I.key===o).fetchFunction(U);if(J&&J.results){const I=new Set(n.map(oe=>oe.id)),se=J.results.filter(oe=>!I.has(oe.id));se.length>0?(i(oe=>[...oe,...se]),g(U),h(J.total_pages),ne=!0):(U++,B++)}else break}catch(P){console.error("Error fetching more movies:",P);break}ne||g(p),b(!1)}},Q=U=>{window.scrollTo({top:0,behavior:"smooth"}),setTimeout(()=>{A(`/detalhe/${U}`)},300)},$=U=>new Date(U).toLocaleDateString("pt-BR");return z.jsxs(MT,{children:[x&&z.jsx(to,{movieId:E,setShowModal:v}),z.jsxs(RT,{children:[z.jsx("h1",{children:"🎬 Filmes"}),z.jsx("p",{children:"Descubra os melhores filmes, desde os mais populares até os clássicos atemporais"})]}),z.jsx(DT,{children:w.map(U=>z.jsx(jT,{active:o===U.key,onClick:()=>D(U.key),children:U.label},U.key))}),r&&n.length===0?z.jsx(kT,{children:z.jsx("div",{className:"spinner"})}):n.length>0?z.jsxs(z.Fragment,{children:[z.jsx(NT,{children:n.map(U=>z.jsxs(LT,{onClick:()=>Q(U.id),children:[z.jsx(BT,{children:z.jsx("img",{src:jn(U.poster_path),alt:U.title,onError:B=>{B.target.src="/placeholder-movie.svg"}})}),z.jsxs(UT,{children:[z.jsx("h3",{children:U.title}),z.jsx("p",{children:U.overview}),z.jsxs(HT,{children:[z.jsx(qT,{children:z.jsx("span",{children:U.vote_average?.toFixed(1)})}),z.jsx(GT,{children:U.release_date&&$(U.release_date)})]})]})]},U.id))}),d<p&&z.jsx(YT,{onClick:j,disabled:r||S,children:r||S?"Carregando...":"Carregar Mais"}),d>=p&&n.length>0&&z.jsxs("div",{style:{textAlign:"center",margin:"50px 0",color:"#888"},children:[z.jsx("p",{children:"🎬 Você explorou todos os filmes desta categoria!"}),z.jsx("p",{children:"Experimente outro filtro para descobrir mais conteúdo."})]})]}):z.jsxs(VT,{children:[z.jsx("h2",{children:"Nenhum filme encontrado"}),z.jsx("p",{children:"Tente selecionar um filtro diferente"})]})]})}const $T=$l`
  0%,
  100% {
    background-position: 0% 50%;
  }
...
`;function p5(){return z.jsx(f5,{children:z.jsx(d5,{children:"© 2025 DevMovies - Kássio Barros"})})}function h5(){return z.jsxs(z.Fragment,{children:[z.jsx(c5,{}),z.jsx(Hy,{}),z.jsx(p5,{})]})}function m5(){return z.jsx(Gy,{children:z.jsxs(ra,{element:z.jsx(h5,{}),children:[z.jsx(ra,{path:"/",element:z.jsx(OT,{})}),z.jsx(ra,{path:"/movies",element:z.jsx(XT,{})}),z.jsx(ra,{path:"/series",element:z.jsx(r5,{})}),z.jsx(ra,{path:"/detalhe/:id",element:z.jsx(Yc,{})}),z.jsx(ra,{path:"/movie/:id",element:z.jsx(Yc,{})}),z.jsx(ra,{path:"/serie/:id",element:z.jsx(Yc,{})})]})})}const g5=vS`
    * {
        margin: 0;
        padding: 0;
        box-sizing: border-box;
